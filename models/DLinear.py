...
DLinear (Decomposition Linear) is a simple yet effective baseline for time series
forecasting. It decomposes the input into trend and seasonal components, then
applies separate linear layers to each component.

Key Features:
    - Series decomposition: Separates trend and seasonal patterns
    - Linear projections: Simple linear layers for each component
    - Individual or shared parameters: Option for per-variable or shared weights
